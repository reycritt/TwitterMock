# Project 2 - *Twitter4Android*

**Twitter4Android** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://github.com/reycritt/TwitterMock/blob/master/Part%202.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

## Notes

- SQLite was difficult to understand, despite the helpful video and reading the notes (this is on me, not the tutorial)
...
**Twitter4Android** is an android app that allows a user to view his Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://github.com/reycritt/TwitterMock/blob/master/20201009_171844.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

## Notes

- The rate limit on reloading tweets was a bit of a nuisance when testing
